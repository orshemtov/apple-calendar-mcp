...
struct Main {
    static func main() async throws {
        ...
        let app = AppleCalendarServer(dependencies: .live(), logger: logger)
    ...
    var output: String {
        ...
        case .help:
            return """
                ...
                A local MCP server for Apple Calendar on macOS.

                Usage:
                  apple-calendar-mcp
                  apple-calendar-mcp --help
                  apple-calendar-mcp --version

                Notes:
                  - The server communicates over stdio.
                  - It runs against the local macOS user's Calendar data.
